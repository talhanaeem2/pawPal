...
import { petQuery, petVaccinationsQuery, vaccinationsQuery } from '@/lib/queries';
...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from '@/components/ui/common/breadcrumb';
...
export const Route = createFileRoute('/_authenticated/pets/$petId/vaccinations')({
  ...
  head: () => ({ meta: [{ title: "Pet Vaccinations · Pawpal" }] }),
  component: VaccinationsPetPage,
  errorComponent: ({ reset }: ErrorComponentProps) => <InlineErrorState onRetry={reset} />,
  notFoundComponent: () => <NotFoundState />
})

function VaccinationsPetPage() {
  ...
  return (
    <Page>
      ...
      <ConfirmDialog
        ...
        title={`Remove ${selectedVaccination?.vaccine_name ?? "this vaccine"}?`}
