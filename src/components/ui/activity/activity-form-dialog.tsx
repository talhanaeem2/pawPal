      ...
      const payload = {
        ...
        duration_min:
          EXERCISE_TYPES.has(data.activity_type) && data.duration_min
            ...
            : null,
        weight: data.activity_type === "weight" && data.weight ? Number(data.weight) : null,
        length: data.activity_type === "length" && data.length ? Number(data.length) : null,
    ...
    >
      ...
      >
        ...
        <Field label="Pet" error={form.errors.pet_id}>
          <Select value={form.values.pet_id} onValueChange={handlePetChange} required>
            <SelectTrigger>
        ...
        <Field label="Type" error={form.errors.activity_type}>
          <Select value={form.values.activity_type} onValueChange={handleTypeChange}>
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
